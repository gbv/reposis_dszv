...
<xsl:stylesheet version="1.0"
    ...
    <xsl:param name="MCR.NameOfProject" select="'dszv'"/>
    <xsl:template name="mir.header">
        <div id="head" class="container">
          ...
          <div id="site_logo" role="projectlogo" class="col-sm-3">
                        <h1>
                            <a href="http://dszv.it/{$CurrentLang}/">
                                <img alt="DSZV-Logo" src="{$WebApplicationBaseURL}images/logos/logo-dszv-jubi-336.jpg" />
                            </a>
                        </h1>
                    </div>
                        ...
                        <h2 id="project_title">
                            <xsl:choose>
                                <xsl:when test="$CurrentLang='it'">
                                    <img alt="istituzione" src="{$WebApplicationBaseURL}images/logos/titolo.gif" />
                                </xsl:when>
                                <xsl:otherwise>
                                    <img alt="Institution" src="{$WebApplicationBaseURL}images/logos/title.gif" />
                                </xsl:otherwise>
                            </xsl:choose>
                        </h2>
    ...
    <div id="searchLangSwitch" class="pull-right">
      <div id="langswitch">
                <xsl:choose>
                    <xsl:when test="$CurrentLang='it'">
                        <a href="?lang=de"><xsl:value-of select="i18n:translate('dszv.language')"/></a>
                    </xsl:when>
                    <xsl:otherwise>
                        <a href="?lang=it"><xsl:value-of select="i18n:translate('dszv.language')"/></a>
                    </xsl:otherwise>
                </xsl:choose>
            </div>
        ...
        <form action="{$WebApplicationBaseURL}servlets/solr/find" class="navbar-form form-inline" role="search">
                    ...
                    <button type="submit" title="{i18n:translate('mir.cosmol.navsearch.title')}" class="btn btn-primary">
    ...
    <div class="navbar navbar-default mir-side-nav">
            <nav class="mir-main-nav-entries">
                <ul class="nav navbar-nav">
                    ...
                    <li class="dropdown">
                        <a href="#" data-toggle="dropdown" class="dropdown-toggle" id="dszvLibrary">
                    ...
                    <li class="dropdown">
                        <a href="#" data-toggle="dropdown" class="dropdown-toggle" id="dszvInstitute">
                            <xsl:value-of select="i18n:translate('dszv.institute')" /> <span class="caret"></span>
                        </a>
                        <ul aria-labelledby="dszvInstitute" role="menu" class="dropdown-menu">
                            <li>
                                <xsl:choose>
                                    <xsl:when test="$CurrentLang='it'">
                                        <a href="http://www.dszv.it/it/contatti/"><xsl:value-of select="i18n:translate('dszv.contact')" /></a>
                                    </xsl:when>
                                    <xsl:otherwise>
                                        <a href="http://www.dszv.it/de/kontakt/"><xsl:value-of select="i18n:translate('dszv.contact')" /></a>
                                    </xsl:otherwise>
                                </xsl:choose>
                            </li>
                            <li>
                                <xsl:choose>
                                    <xsl:when test="$CurrentLang='it'">
                                        <a href="http://www.dszv.it/it/crediti/"><xsl:value-of select="i18n:translate('dszv.imprint')" /></a>
                                    </xsl:when>
                                    <xsl:otherwise>
                                        <a href="http://www.dszv.it/de/impressum/"><xsl:value-of select="i18n:translate('dszv.imprint')" /></a>
                                    </xsl:otherwise>
                                </xsl:choose>
                            </li>
                            <li>
                                <xsl:choose>
                                    <xsl:when test="$CurrentLang='it'">
                                        <a href="https://www.iubenda.com/privacy-policy/7992015/legal"><xsl:value-of select="i18n:translate('dszv.privacy')" /></a>
                                    </xsl:when>
                                    <xsl:otherwise>
                                        <a href="https://www.iubenda.com/privacy-policy/33631120/legal"><xsl:value-of select="i18n:translate('dszv.privacy')" /></a>
                                    </xsl:otherwise>
                                </xsl:choose>
                            </li>
                        </ul>
    ...
    <xsl:template name="mir.footer">
        <div class="container">
            ...
            <div class="col-xs-6 small">
                    ...
                    <a href="http://www.dszv.it" title="Home">www.dszv.it</a>
                </div>
            <div class="col-xs-6 small">
...
<!--Templates absence causes exception in mir-cosmol-layout.xsl-->
