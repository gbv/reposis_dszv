...
<xsl:stylesheet version="1.0"
  ...
  <xsl:template name="mir.jumbotwo">
    ...
    <xsl:if test="//div/@class='jumbotwo'">
      <div class="jumbotron">
        <div class="container">
          <h1>Dokumentenserver des Deutschen Studienzentrums in Venedig (DSZV)</h1>
    ...
    <div class="container">
      <div class="row">
        <div class="col-xs-12 col-sm-6 col-md-4">
          <h4>Über uns</h4>
          <p>
            Hier wird gerade die neue Version des Publikationsservers erstellt
            <span class="read_more">
              <a href="http://repository.dszv.it/">zur aktuellen Version ...</a>
            </span>
          </p>
        </div>
